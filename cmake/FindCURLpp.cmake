...
# ~ set(CURLPP_INCLUDE_SEARCHES "Easy.hpp" "cURLpp.hpp" "Info.hpp" "Infos.hpp"
# "Option.hpp" "Options.hpp" "Form.hpp")
set(CURLPP_INCLUDE_SEARCHES "cURLpp.hpp")

find_path(
  CURLPP_INCLUDE_DIR
  NAMES ${CURLPP_INCLUDE_SEARCHES}
  PATH_SUFFIXES ${CURLPP_INCLUDE_PREFIX})
find_library(
  CURLPP_LIBRARY
  NAMES ${CURLPP_FIND_NAMES}
  PATHS "/usr/local/lib")
...
find_package_handle_standard_args(CURLpp DEFAULT_MSG CURLPP_LIBRARY
                                  CURLPP_INCLUDE_DIR)
